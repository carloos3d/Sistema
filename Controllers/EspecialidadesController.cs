...
namespace WebApplication1.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EspecialidadeId,name")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EspecialidadeId,name")] Especialidade especialidade)
        {
            if (ModelState.IsValid)
            {
